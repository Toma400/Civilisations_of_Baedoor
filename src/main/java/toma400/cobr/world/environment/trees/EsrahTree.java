...
public class EsrahTree extends Tree {

    private static final int BASE_HEIGHT = 3;
    private static final int FIRST_RANDOM_HEIGHT = 3;
    private static final int SECOND_RANDOM_HEIGHT = 4;

    private static final int LEAVE_RADIUS = 3;
    private static final int LEAVE_OFFSET = 3;
    private static final int LEAVE_HEIGHT = 3;

    public static final BaseTreeFeatureConfig ESRAH_TREE_CONFIG = (new BaseTreeFeatureConfig.Builder(
            new SimpleBlockStateProvider(CobrBlocks.ESRAH_LOG.get().defaultBlockState()),
            new SimpleBlockStateProvider(CobrBlocks.ESRAH_LEAVES.get().defaultBlockState()),
    ...
    protected ConfiguredFeature<BaseTreeFeatureConfig, ?> getConfiguredFeature(Random random, boolean largeHive) {
        return Feature.TREE.configured(ESRAH_TREE_CONFIG);
    }
}
