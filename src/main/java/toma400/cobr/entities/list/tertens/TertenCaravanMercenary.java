...
public class TertenCaravanMercenary extends PathfinderMob {

    public static final String ID = "terten_caravan_mercenary";

    public TertenCaravanMercenary(EntityType<? extends PathfinderMob> entity, Level world) {
        super(entity, world);
    }
    ...
    public static ArrayList<?> mobs_helping() {
        ...
        helping_mobs.add(CobrEntities.Reg.TERTEN_CARAVAN_MERCENARY);
        return helping_mobs;
    }
