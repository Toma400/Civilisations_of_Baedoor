...
public class CobrBlocks {
    ...
    public static final RegistryObject<Block> RAW_DUNE_GOLD_BLOCK = registerBlock("raw_dune_gold_block",
            () -> new Block(Block.Properties.of(Material.METAL).sound(SoundType.METAL).strength(4f, 4f).requiresCorrectToolForDrops()), CobrTab.COBR_TAB, 0);
    public static final RegistryObject<Block> BLOCK_OF_DUNE_GOLD = registerBlock("block_of_dune_gold",
            () -> new Block(Block.Properties.of(Material.METAL).sound(SoundType.METAL).strength(12f, 8f).requiresCorrectToolForDrops()), CobrTab.COBR_TAB, 0);
    //EOTIC BAMBOO + VARIANTS
    public static final RegistryObject<Block> EOTIC_BAMBOO_BLOCK = registerBlock("eotic_bamboo_block",
            () -> new FlammableBlocks.Planks(Block.Properties.of(Material.BAMBOO).sound(SoundType.BAMBOO).strength(1f, 2f)), CobrTab.COBR_TAB, 0);
    public static final RegistryObject<Block> EOTIC_BAMBOO_STAIRS = registerBlock("eotic_bamboo_stairs",
            () -> new FlammableBlocks.Stairs(() -> CobrBlocks.EOTIC_BAMBOO_BLOCK.get().defaultBlockState(), Block.Properties.of(Material.BAMBOO).sound(SoundType.BAMBOO).strength(1f, 2f)), CobrTab.COBR_TAB, 0);
    public static final RegistryObject<Block> EOTIC_BAMBOO_SLAB = registerBlock("eotic_bamboo_slab",
            () -> new FlammableBlocks.Slab(Block.Properties.of(Material.BAMBOO).sound(SoundType.BAMBOO).strength(1f, 2f)), CobrTab.COBR_TAB, 0);
    public static final RegistryObject<Block> EOTIC_BAMBOO_MAT = registerBlock("eotic_bamboo_mat",
            () -> new MatBlocks(Block.Properties.of(Material.BAMBOO).sound(SoundType.BAMBOO).strength(0.5f, 0.5f).noOcclusion()), CobrTab.COBR_TAB, 0);
    public static final RegistryObject<Block> EOTIC_BAMBOO_LAMP = registerBlock("eotic_bamboo_lamp",
            () -> new FlammableBlocks.Planks(Block.Properties.of(Material.BAMBOO).sound(SoundType.BAMBOO).strength(1f, 2f).lightLevel(s -> 15)), CobrTab.COBR_TAB, 0);
    //TRAVELLER STONES
    public static final RegistryObject<Block> EMPTY_TRAVELLER_STONE = registerBlock("empty_traveller_stone",
            () -> new TravellerStoneBlocks(Block.Properties.of(Material.STONE).sound(SoundType.STONE).strength(0.8f,0.8f).requiresCorrectToolForDrops()), CobrTab.COBR_TAB, 0);
    ...
    public static final RegistryObject<Block> DUNE_SANDSTONE_COAL_ORE = registerBlock("dune_sandstone_coal_ore",
            () -> new OreBlock(Block.Properties.of(Material.STONE).sound(SoundType.STONE).strength(1.2f,1.2f).requiresCorrectToolForDrops()), CobrTab.COBR_TAB, 0);
    ...
    public static final RegistryObject<Block> DUNE_SAND = registerBlock("dune_sand",
            () -> new Block(Block.Properties.of(Material.SAND).sound(SoundType.SAND).strength(0.7f, 1f)), CobrTab.COBR_TAB, 0);
    ...
    public static final RegistryObject<Block> WET_DUNE_SAND = registerBlock("wet_dune_sand",
            () -> new Block(Block.Properties.of(Material.STONE).sound(SoundType.SAND).strength(1f, 1f)), CobrTab.COBR_TAB, 0);
    public static final RegistryObject<Block> BRIGHT_DUNE_SAND = registerBlock("bright_dune_sand",
            () -> new Block(Block.Properties.of(Material.STONE).sound(SoundType.SAND).strength(0.7f, 1f)), CobrTab.COBR_TAB, 0);
    public static final RegistryObject<Block> DUNE_SANDSTONE = registerBlock("dune_sandstone",
            () -> new Block(Block.Properties.of(Material.STONE).sound(SoundType.STONE).strength(0.8f, 0.8f).requiresCorrectToolForDrops()), CobrTab.COBR_TAB, 0);
    public static final RegistryObject<Block> DUNE_SANDSTONE_SLAB = registerBlock("dune_sandstone_slab",
            () -> new SlabBlock(Block.Properties.of(Material.STONE).sound(SoundType.STONE).strength(0.8f, 0.8f).requiresCorrectToolForDrops()), CobrTab.COBR_TAB, 0);
    public static final RegistryObject<Block> DUNE_SANDSTONE_STAIRS = registerBlock("dune_sandstone_stairs",
            () -> new StairsBlock(() -> CobrBlocks.DUNE_SANDSTONE.get().defaultBlockState(), Block.Properties.of(Material.STONE).sound(SoundType.STONE).strength(0.8f, 0.8f).requiresCorrectToolForDrops()), CobrTab.COBR_TAB, 0);
    public static final RegistryObject<Block> DUNE_SANDSTONE_BRICKS = registerBlock("dune_sandstone_bricks",
            () -> new Block(Block.Properties.of(Material.STONE).sound(SoundType.STONE).strength(6f, 6f).requiresCorrectToolForDrops()), CobrTab.COBR_TAB, 0);
    public static final RegistryObject<Block> DUNE_SANDSTONE_BRICKS_SLAB = registerBlock("dune_sandstone_bricks_slab",
            () -> new SlabBlock(Block.Properties.of(Material.STONE).sound(SoundType.STONE).strength(6f, 6f).requiresCorrectToolForDrops()), CobrTab.COBR_TAB, 0);
    public static final RegistryObject<Block> DUNE_SANDSTONE_BRICKS_STAIRS = registerBlock("dune_sandstone_bricks_stairs",
            () -> new StairsBlock(() -> CobrBlocks.DUNE_SANDSTONE_BRICKS.get().defaultBlockState(), Block.Properties.of(Material.STONE).sound(SoundType.STONE).strength(6f, 6f).requiresCorrectToolForDrops()), CobrTab.COBR_TAB, 0);
    ...
    public static final RegistryObject<Block> ESRAH_LOG = registerBlock("esrah_log",
            () -> new FlammableBlocks.LogBlocks(Block.Properties.of(Material.WOOD).sound(SoundType.WOOD).strength(2f, 2f)), CobrTab.COBR_TAB, 300);
    ...
    public static final RegistryObject<Block> ESRAH_PLANKS = registerBlock("esrah_planks",
            () -> new FlammableBlocks.Planks(Block.Properties.of(Material.WOOD).sound(SoundType.WOOD).strength(2f, 3f)), CobrTab.COBR_TAB, 300);
    ...
    public static final RegistryObject<Block> ESRAH_STAIRS = registerBlock("esrah_stairs",
            () -> new FlammableBlocks.Stairs(() -> CobrBlocks.ESRAH_PLANKS.get().defaultBlockState(), Block.Properties.of(Material.WOOD).sound(SoundType.WOOD).strength(2f, 3f).noOcclusion()), CobrTab.COBR_TAB, 300);
    public static final RegistryObject<Block> ESRAH_SLAB = registerBlock("esrah_slab",
            () -> new FlammableBlocks.Slab(Block.Properties.of(Material.WOOD).sound(SoundType.WOOD).strength(2f, 3f).noOcclusion()), CobrTab.COBR_TAB, 150);
    public static final RegistryObject<Block> ESRAH_TRAPDOOR = registerBlock("esrah_trapdoor",
            () -> new FlammableBlocks.Trapdoor(Block.Properties.of(Material.WOOD).sound(SoundType.WOOD).strength(2f, 3f).noOcclusion()), CobrTab.COBR_TAB, 300);
    public static final RegistryObject<Block> ESRAH_DOOR = registerBlock("esrah_door",
            () -> new FlammableBlocks.Door(Block.Properties.of(Material.WOOD).sound(SoundType.WOOD).strength(2f, 3f).noOcclusion()), CobrTab.COBR_TAB, 200);
    public static final RegistryObject<Block> ESRAH_FENCE = registerBlock("esrah_fence",
            () -> new FlammableBlocks.Fence(Block.Properties.of(Material.WOOD).sound(SoundType.WOOD).strength(2f, 3f).noOcclusion()), CobrTab.COBR_TAB, 300);
    public static final RegistryObject<Block> ESRAH_FENCE_GATE = registerBlock("esrah_fence_gate",
            () -> new FlammableBlocks.FenceGate(Block.Properties.of(Material.WOOD).sound(SoundType.WOOD).strength(2f, 3f).noOcclusion()), CobrTab.COBR_TAB, 300);
    public static final RegistryObject<Block> LAIS_STAIRS = registerBlock("lais_stairs",
            () -> new FlammableBlocks.Stairs(() -> CobrBlocks.LAIS_PLANKS.get().defaultBlockState(), Block.Properties.of(Material.WOOD).sound(SoundType.WOOD).strength(2f, 3f).noOcclusion()), CobrTab.COBR_TAB, 300);
    ...
    public static final RegistryObject<Block> ESRAH_LEAVES = registerBlock("esrah_leaves",
            () -> new FlammableBlocks.Leaves(Block.Properties.of(Material.LEAVES).sound(SoundType.GRASS).strength(0.2f, 0.2f).noOcclusion().requiresCorrectToolForDrops()), CobrTab.COBR_TAB, 0);
    //public static final RegistryObject<Block> ESRAH_SAPLING = registerBlock("esrah_sapling",
    //        () -> new SaplingBlock(new EsrahTreeGrower(), Block.Properties.of(Material.LEAVES).sound(SoundType.CROP).strength(0f, 0f).noOcclusion()), CobrTab.COBR_TAB, 0);
    ...
    //        () -> new SaplingBlock(new LaisTreeGrower(), Block.Properties.of(Material.LEAVES).sound(SoundType.CROP).strength(0f, 0f).noOcclusion()), CobrTab.COBR_TAB, 0);

    //EMPIRE-RELATED
    public static final RegistryObject<Block> CIVILISATION_TABLE = registerBlock("civilisation_table",
            () -> new CivilisationTableBlock(Block.Properties.of(Material.WOOD).sound(SoundType.WOOD).strength(2f, 50f)), CobrTab.COBR_TAB, 0);
