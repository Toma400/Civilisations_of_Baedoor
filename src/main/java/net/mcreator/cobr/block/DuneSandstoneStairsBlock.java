...
public class DuneSandstoneStairsBlock extends CobrModElements.ModElement {
	@ObjectHolder("cobr:dune_sandstone_stairs")
	public static final Block block = null;
	public DuneSandstoneStairsBlock(CobrModElements instance) {
		super(instance, 15);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(() -> new Block(
					...
					Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(0.8f, 0.8f).setLightLevel(s -> 0)
							.harvestLevel(0).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("dune_sandstone_stairs");
		}
