...
public class FloweryLaisTrapdoorBlock extends CobrModElements.ModElement {
	@ObjectHolder("cobr:flowery_lais_trapdoor")
	public static final Block block = null;
	public FloweryLaisTrapdoorBlock(CobrModElements instance) {
		super(instance, 234);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("flowery_lais_trapdoor");
		}
