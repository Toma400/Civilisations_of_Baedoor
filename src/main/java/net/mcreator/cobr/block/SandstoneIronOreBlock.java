...
public class SandstoneIronOreBlock extends CobrModElements.ModElement {
	@ObjectHolder("cobr:sandstone_iron_ore")
	public static final Block block = null;
	public SandstoneIronOreBlock(CobrModElements instance) {
		super(instance, 3);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstone_iron_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("cobr:sandstone_iron_ore_match"), () -> CustomRuleTest.codec);
