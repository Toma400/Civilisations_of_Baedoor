...
public class DuneSandstoneBrickWallBlock extends CobrModElements.ModElement {
	@ObjectHolder("cobr:dune_sandstone_brick_wall")
	public static final Block block = null;
	public DuneSandstoneBrickWallBlock(CobrModElements instance) {
		super(instance, 21);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("dune_sandstone_brick_wall");
		}
