...
public class EvergreenDepthsTravellerStoneBlock extends CobrModElements.ModElement {
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(
					TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("evergreen_depths_traveller_stone"));
		}
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("evergreen_depths_traveller_stone");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("evergreen_depths_traveller_stone");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Evergreen Depths Traveller Stone");
		}
