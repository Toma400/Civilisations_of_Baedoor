...
public class RainforestIslandsTravellerStoneBlock extends CobrModElements.ModElement {
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(
					TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("rainforest_islands_traveller_stone"));
		}
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("rainforest_islands_traveller_stone");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("rainforest_islands_traveller_stone");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Rainforest Islands Traveller Stone");
		}
