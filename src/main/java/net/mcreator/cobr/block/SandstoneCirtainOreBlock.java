...
public class SandstoneCirtainOreBlock extends CobrModElements.ModElement {
	@ObjectHolder("cobr:sandstone_cirtain_ore")
	public static final Block block = null;
	public SandstoneCirtainOreBlock(CobrModElements instance) {
		super(instance, 268);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstone_cirtain_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("cobr:sandstone_cirtain_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("sandstone_cirtain_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("cobr:sandstone_cirtain_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
