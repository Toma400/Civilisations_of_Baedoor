...
import net.mcreator.cobr.procedures.SpawnBlockMercenaryCampProcedure;
...
public class SpawnBlockMercenaryCampTertenBlock extends CobrModElements.ModElement {
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.AIR).sound(SoundType.METAL).hardnessAndResistance(-1, 3600000).setLightLevel(s -> 0)
					.doesNotBlockMovement().notSolid().tickRandomly().setOpaque((bs, br, bp) -> false));
			this.setDefaultState(this.stateContainer.getBaseState().with(WATERLOGGED, false));
			setRegistryName("spawn_block_mercenary_camp_terten");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			return VoxelShapes.or(makeCuboidShape(7, 7, 7, 9, 9, 9));
		}
