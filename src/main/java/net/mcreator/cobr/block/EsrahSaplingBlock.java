...
import net.mcreator.cobr.procedures.TreeHeightCheck5hProcedure;
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			...
			if (worldIn instanceof IWorld) {
				...
				additionalCondition = TreeHeightCheck5hProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world));
			}
			Block ground = state.getBlock();
			return (ground == HardenedSandBlock.block) && additionalCondition;
		}
