...
public class EoticBamboo1Structure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("eotic_bamboo_1"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("cobr:eotic_bamboo_1"), configuredFeature);
		}
	}
	@SubscribeEvent
