...
import net.mcreator.cobr.entity.renderer.SpawnEntityBambooRenderer;
...
public class SpawnEntityBambooEntity extends CobrModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(null)).setRegistryName("spawn_entity_bamboo_spawn_egg"));
	}
