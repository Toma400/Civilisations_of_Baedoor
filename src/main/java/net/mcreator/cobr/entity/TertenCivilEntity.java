...
import net.mcreator.cobr.entity.renderer.TertenCivilRenderer;
...
public class TertenCivilEntity extends CobrModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10066330, -8618919, new Item.Properties().group(CivilisationsofBaedoorItemGroup.tab))
				.setRegistryName("terten_civil_spawn_egg"));
	}
