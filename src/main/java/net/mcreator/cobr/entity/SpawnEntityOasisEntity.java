...
package net.mcreator.cobr.entity;
...
import net.mcreator.cobr.procedures.SpawnEntitiesUseProcedure;
import net.mcreator.cobr.entity.renderer.SpawnEntityOasisRenderer;
...
public class SpawnEntityOasisEntity extends CobrModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(null)).setRegistryName("spawn_entity_oasis_spawn_egg"));
	}
